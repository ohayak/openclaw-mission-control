...
import { Route as LayoutProjectsProjectIdMemoryRouteImport } from './routes/_layout/projects.$projectId.memory'
...
const LayoutCostsRoute = LayoutCostsRouteImport.update({
  id: '/costs',
  path: '/costs',
  getParentRoute: () => LayoutRoute,
} as any)
...
const LayoutProjectsProjectIdMemoryRoute =
  LayoutProjectsProjectIdMemoryRouteImport.update({
    id: '/memory',
    path: '/memory',
...
export interface FileRoutesByFullPath {
  ...
  '/projects/$projectId/memory': typeof LayoutProjectsProjectIdMemoryRoute
}
...
export interface FileRoutesById {
  ...
  '/_layout/projects/$projectId/memory': typeof LayoutProjectsProjectIdMemoryRoute
}
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_layout/projects/$projectId/memory'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/costs': {
      ...
      path: '/costs'
      fullPath: '/costs'
      preLoaderRoute: typeof LayoutCostsRouteImport
      parentRoute: typeof LayoutRoute
    }
    '/_layout/agents': {
      id: '/_layout/agents'
    ...
    '/_layout/projects/$projectId/memory': {
      id: '/_layout/projects/$projectId/memory'
      path: '/memory'
      fullPath: '/projects/$projectId/memory'
      preLoaderRoute: typeof LayoutProjectsProjectIdMemoryRouteImport
...
interface LayoutProjectsProjectIdRouteChildren {
  LayoutProjectsProjectIdMemoryRoute: typeof LayoutProjectsProjectIdMemoryRoute
}

const LayoutProjectsProjectIdRouteChildren: LayoutProjectsProjectIdRouteChildren =
  {
    LayoutProjectsProjectIdMemoryRoute: LayoutProjectsProjectIdMemoryRoute,
  }
...
interface LayoutRouteChildren {
  ...
  LayoutCostsRoute: typeof LayoutCostsRoute
...
const LayoutRouteChildren: LayoutRouteChildren = {
  ...
  LayoutCostsRoute: LayoutCostsRoute,
